		...
		<div class="container">
			<div class="row">
				<div class="col-6 m-auto mt-5 p-3 border border-secondary rounded">
					<h3 class="text-center text-success">Update Patient Details</h3>
					<form action="<%=request.getContextPath()%>/update" method="post">
						...
						<div class="form-group py-2">
							<label for="patientName"> Patient Name </label> <input
								...
								value="${patient.patientName}" placeholder="Name">
						</div>
						<div class="form-group py-2">
							<label for="patientAge"> Patient Age </label> <input type="text"
								class="form-control" name="patientAge"
								value="${patient.patientAge}" placeholder="Age">
						</div>
						<div class="form-group py-2">
							<label for="patientAddress"> Patient Address </label> <input
								type="text" class="form-control" name="patientAddress"
								value="${patient.patientAddress}" placeholder="Address">
						</div>
							
						<div class="d-flex">
							<input class="btn btn-outline-success my-3" type="submit"value="Update Patient"> 
							
							<a href="<%=request.getContextPath()%>/list" class="text-decoration-none mx-2"> 
								<input class="btn btn-outline-danger my-3" type="button" value="Cancel">
							</a>
						</div>
					</form>
				</div>
